...
@synthesize fullurl,sampleUrl,thumbUrl,tags,rating,cachedThumb,isMoreCell,cachedSample,webUrl;
#pragma mark - Inits
...
- (void)downloadDidFinish:(NSURLDownload *)download
{
    ...
    if ([self.downloadDelegate respondsToSelector:@selector(_removeDownloadingProcessView)]) {
        [self.downloadDelegate _removeDownloadingProcessView];
    }
}
