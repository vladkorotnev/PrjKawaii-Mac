...
@interface GBVSaverConfigWindowControllerSV ()

@end

@implementation GBVSaverConfigWindowControllerSV
...
- (IBAction)openApp:(id)sender {
    [[NSWorkspace sharedWorkspace]launchApplication:@"GBBrowser"];
}
...
- (void)windowDidLoad
{
    ...
    if ([[conf objectForKey:@"tags"] isEqualToString:@""]) {
        [self.tagField setStringValue:@"< newest uploads >"];
    }
